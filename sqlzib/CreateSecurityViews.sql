...
-- Public course information accessible to everyone
...
-- Prevent individual identification through aggregates
...
HAVING COUNT(DISTINCT a.StudentID) >= 3;
GO
...
PRINT 'Security views created successfully.';
GO